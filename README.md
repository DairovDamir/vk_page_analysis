...
Нет явной зависимости между временем между опубликованными постами. На первом месте идут посты, промежуток времени между которыми составил 5 дней, при том, что посты промежуток между которыми составил 4 и 6 дней находятся в середине списка. 
