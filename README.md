...
- PostgreSQL, Clickhouse для анализа данных
- Apache Superset для визуализации
- Docker для развертывания PostgreSQL, Clickhouse, Apache Superset
- Модуль psycopg2 для загруки данных в PostgreSQL
- Модуль clickhouse_connect для загруки данных в Clickhouse
...
Количество лайков сильно зависит от времени публикации и дня недели. Лучшее время для публикации, чтобы оно набрало максимальное количество лайков - выходной день в 8-9 утра.
